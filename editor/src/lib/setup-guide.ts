...
export const faq = [
  ...
  ["Bosun cannot find the Captain. What should I check?", "Use a USB data cable, connect directly to the computer and close other serial apps. Bosun requests the bootloader automatically after you choose Install. If this fails, follow your current firmware's bootloader procedure; PaintAudio 5 supplies MIDICAPTAINBOOT.HTML. Keep the same USB port. Holding footswitch 1 opens USB Setup, not the RPI-RP2 bootloader."],
  ...
  ["Which devices and systems are verified?", "This setup targets the 10-switch RP2040 MIDI Captain with 8 MiB flash and the Kemper PROFILER Player. Windows first installation from PaintAudio 5.15 passed a hardware test with the corrected installer. Use Desktop 0.6.8 or later: 0.6.7 cannot detect that stock firmware. Other stock versions, Captain models and macOS/Linux operation remain unverified."],
];
