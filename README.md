...
The experimental C firmware branch has a separate [hardware validation report](docs/native-firmware-hardware-validation.md), with measured USB response times, configuration recovery checks and a capture of Stage connected to the real devices.
